...
interface MobileWeeklyScheduleGridProps {
  date: Date;
...
export function MobileWeeklyScheduleGrid({ 
  date, 
  onSave, 
  onCancel,
  hasExistingSchedule,
  existingEvents
}: MobileWeeklyScheduleGridProps) {
      ...
      <Card className="overflow-hidden border border-border">
        ...
        <CardContent className="p-0">
          <div className="flex flex-col">
            <div className="grid grid-cols-[60px_repeat(7,minmax(40px,1fr))] sticky top-0 z-10 bg-background border-b text-xs">
            ...
            <ScrollArea className="h-[calc(100vh-260px)]">
              <div className="min-w-[calc(100vw-32px)]">
                {hours.map(hour => (
                  <div key={hour} className="grid grid-cols-[60px_repeat(7,minmax(40px,1fr))]">
