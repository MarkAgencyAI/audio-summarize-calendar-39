          ...
          <CarouselContent>
            ...
            <CarouselItem className="basis-full">
              <div className="p-1">
                ...
                {showTranscriptionOptions && <Button variant="outline" className="w-full mt-2" onClick={() => setTranscriptionOpen(true)}>
            ...
            {user?.role === "teacher" && <CarouselItem className="basis-full">
                <div className="p-1">
                  <div className="text-center mb-2">
